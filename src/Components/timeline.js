          ...
          <div class="flex flex-row-reverse md:contents">
            <div class=" col-start-1 col-end-5 p-4 my-4 ml-auto animate-fade-in-right">
              <Fade left>
                ...
                <h3 class="mb-1">
                  Placed 1º with 3 very talented fellow students/friends.
                </h3>
              </Fade>
              <img
                src={BotOlympicsAward}
                style={{
                  width: 270,
                  height: 250,
                  position: "inherit",
          ...
          <div class="flex md:contents">
            ...
            <div class=" col-start-6 col-end-10 p-4 my-4 mr-auto">
              <Fade right>
                ...
                <p class="mb-1">
                  Placed 3º with with 3 very talented fellow students/friends
                </p>
              </Fade>
              <img
                src={Ebec}
          ...
          <div class="flex flex-row-reverse md:contents">
            <div class="col-start-1 col-end-5 p-4 my-4 ml-auto">
              <Fade left>
                ...
                <p class="leading-tight text-justify text-black">
                  Placed 1º with 2 very talented fellow students/friends
                </p>
              </Fade>
              <img
                src={Best}
